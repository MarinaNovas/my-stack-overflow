...
export const SignInSchema = z.object({
  ...
  password: z
    .string()
    .min(6, { message: "Password mast be at least 6 characters long" })
...
export const SignUpSchema = z.object({
  ...
  email: z.string().min(1, { message: "Email is required." }).pipe(z.email("Please provide a valid email address.")),
